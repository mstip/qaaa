...
func (s *Store) seedWithDemoData() {
	...
	getAllTodoTask := model.Task{Id: s.newTaskId(), Name: "Get all todos", Description: "", Type: model.TaskTypeJsonApi, Task: getAllJsonApiTask}
	...
	getTodoTask := model.Task{Id: s.newTaskId(), Name: "Get one todo", Description: "-", Type: model.TaskTypeJsonApi, Task: getJsonApiTask}
